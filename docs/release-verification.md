...
- ZIP SHA-256: `a2c8fbe301df7b492fcc57a01f6d8f66d42de23e11dd4adcd8d3b48931bdbc98`
  (two fixed-input runs produced the same 1,431-byte archive).
...
- Hugo `v0.164.0+extended+withdeploy` built the copied real site at
  `/tmp/imx-post-studio-hugo.H5bNhh`. It produced
  `/tmp/imx-post-studio-hugo.H5bNhh/public/posts/imx-post-studio-verification/index.html`
  ...
  image reference.
- The source bundle was inspected at `/tmp/imx-post-studio-bundle.AY8KSb`.
